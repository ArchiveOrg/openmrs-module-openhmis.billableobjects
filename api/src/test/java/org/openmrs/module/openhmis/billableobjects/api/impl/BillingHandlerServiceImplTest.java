...
public class BillingHandlerServiceImplTest extends BaseModuleWebContextSensitiveTest {
	...
	/**
	 * @see IBillingHandlerService#getActivelyHandledClasses()
	...
	/**
	 * @see IBillingHandlerService#getHandlerTypeNames()
