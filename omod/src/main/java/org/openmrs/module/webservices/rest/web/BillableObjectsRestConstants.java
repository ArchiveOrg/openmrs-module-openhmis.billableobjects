...
public class BillableObjectsRestConstants {
    ...
    public static final String ENCOUNTER_HANDLER_RESOURCE = HANDLER_RESOURCE + "/encounter";
    public static final String DRUGORDER_HANDLER_RESOURCE = HANDLER_RESOURCE + "/drugorder";    
}
